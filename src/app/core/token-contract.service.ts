...
export class TokenContractService {
    private web3: Web3;
    private TOKEN_CONTRACT_ADDRESS: string = "0x0d8cc4b8d15d4c3ef1d70af0071376fb26b5669b";
    private TOKEN_CONTRACT_ABI: any = [
        {
            "constant": true,
            "inputs": [],
    ...
    constructor(
        ...
        this.tokenContract = new this.web3.eth.Contract(this.TOKEN_CONTRACT_ABI, this.TOKEN_CONTRACT_ADDRESS);
    }
